package com.example.dropdownrefresh.Utlis;
...
import com.example.dropdownrefresh.bean.Result;
...
public class OkHttpUtils2<T> {
     ...
     */
    public void execute(final Context context, OnCompleteListener<T> listener) {
        if (listener != null) {
            mListener = listener;
        }
            ...
            public void onResponse(Response response) throws IOException {
                ...
                if (result.getRetCode() == 0) {
                    ...
                    if (result.getRetData() != null) {
                        text = result.getRetData().toString();
                    ...
                    int resId = context.getResources().getIdentifier("msg_" + result.getRetCode(), "string", context.getPackageName());
                    msg.obj = context.getResources().getString(resId);
                }
                mHandler.sendMessage(msg);
